...
Table2Excel::Table2Excel(QString xlsFile)
{
    pExcel     = NULL;
    pWorkbooks = NULL;
    pWorkbook  = NULL;
...
/**
  ...
  *        false: 打开失败
  */
bool Table2Excel::Open(UINT nSheet, bool visible)
{
...
/**
  *@brief Open()的重载函数
  */
bool Table2Excel::Open(QString xlsFile, UINT nSheet, bool visible)
{
    sXlsFile = xlsFile;
    nCurrSheet = nSheet;
    bIsVisible = visible;
...
/**
  ...
  *                  false: 失败
  */
bool Table2Excel::SaveDataFrTable(QTableWidget *tableWidget)
{
...
/**
  ...
  *                   false: 失败
  */
bool Table2Excel::ReadDataToTable(QTableWidget *tableWidget)
{
    if ( NULL == tableWidget )
    {
        return false;
...
/**
  ...
  */
QVariant Table2Excel::GetCellData(UINT row, UINT column)
{
    QVariant data;
...
/**
  ...
  *                   false: 失败
  */
bool Table2Excel::SetCellData(UINT row, UINT column, QVariant data)
{
    bool op = false;
...
/**
  *@brief 获取excel的行数
  */
UINT Table2Excel::GetRowCount()const
{
    return nRowCount;
}
...
/**
  *@brief 获取excel的列数
  */
UINT Table2Excel::GetColumnCount()const
{
    return nColumnCount;
}
