    ...
    ui(new Ui::Dialog)
{
    ...
    //myHelper::setBtnQss(ui->loginButton, "#3498DB", "#FFFFFF", "#5DACE4", "#E5FEFF", "#2483C7", "#A0DAFB");
    ...
    connect(closeButton,SIGNAL(clicked()),this,SLOT(close()));
     ...
     connect(socketClient,SIGNAL(getLoginMsg()),this,SLOT(readMessage()));
...
{int i = ui->passwordEdit->text().length();
    ...
    QString msg=tr("login|")+name.append("/").append(password);
